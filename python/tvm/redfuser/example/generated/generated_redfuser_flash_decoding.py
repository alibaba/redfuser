...
@T.prim_func
def redfuser_flash_decoding1(q: T.Tensor([128, 16, 512, 64], "float16"), k: T.Tensor([128, 16, 512, 64], "float16"), v: T.Tensor([128, 16, 512, 64], "float16"), part_max: T.Tensor([128, 16, 512, 4], "float16"), part_exp_sum: T.Tensor([128, 16, 512, 4], "float16"), part_output: T.Tensor([128, 16, 512, 4, 64], "float16")):
...
@T.prim_func
def redfuser_flash_decoding2(part_max: T.Tensor([128, 16, 512, 4], "float16"), part_exp_sum: T.Tensor([128, 16, 512, 4], "float16"), part_output: T.Tensor([128, 16, 512, 4, 64], "float16"), output: T.Tensor([128, 16, 512, 64], "float16")):
